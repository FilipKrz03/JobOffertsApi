...
namespace WebScrapperService.Services
{
    ...
    {
        public PracujPlScrapperService(ILogger<PracujPlScrapperService> log, IJobHandleMessageProducer jobHandleMessageProducer,
            IWebDriverFactory webDriverFactory)
             : base(log, jobHandleMessageProducer, webDriverFactory, "https://it.pracuj.pl/praca?pn=",
